...
class _ForgetPasswordViewState extends State<ForgetPasswordView> {
  ...
  Widget build(BuildContext context) {
    return MultiProvider(providers: [ChangeNotifierProvider(create: (context)=> ForgetPasswordViewModel())],
      child: Scaffold(
                ...
                AppBackGroundTwoContainer(
                  blueContainerWidget: Column(
                    ...
                    children: [
                      ...
                      sizedBox(hei: 10),
                      Text(AppStrings.forgetPassword, style: AppStyle.whiteBold30,),
                      sizedBox(hei: 10),
                      Text(AppStrings.enterEmailAssociated, style: AppStyle.whiteMedium16,),
                    ],
                  ),
