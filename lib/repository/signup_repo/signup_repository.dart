...
class SignUpRepository
{
  ...
  Future<String> registrationAPI(SignUpPayloadModel model) async {
    ...
    try{
      res =  NetworkApiServices().postAPIWithHeader(AppUrl.signupCredEndPoint, model.toMap(), header);
  ...
  Future<String> verifyOTP(String email, String otp) async {
    ...
    dynamic  res;
    try{
      res =   _apiServices.postAPIWithHeader(AppUrl.verifyUserSignup, data, header);
      Map<String, dynamic> apiAns = await res;
